...
class ListasSeed extends Seeder
{
    ...
    public function run(): void
    {
        $datos = [
            ...
            array('tipo' => 'estados_acciones', 'tipo_valor' => 2, 'valor_numero' => 6, 'valor_texto' => 'info', 'nombre' => 'EQUIPO PLAN GESTIÓN'),
            array('tipo' => 'estados_acciones', 'tipo_valor' => 2, 'valor_numero' => 7, 'valor_texto' => 'danger', 'nombre' => 'RECHAZO PLAN DE GESTIÓN'),
            array('tipo' => 'estados_acciones', 'tipo_valor' => 2, 'valor_numero' => 8, 'valor_texto' => 'success', 'nombre' => 'APROBADO PLAN DE GESTIÓN'),
            ...
            array('tipo' => 'estados_plang', 'tipo_valor' => 2, 'valor_numero' => 4, 'valor_texto' => 'info', 'nombre' => 'VIABILIDAD DELEGADO(A)'),
